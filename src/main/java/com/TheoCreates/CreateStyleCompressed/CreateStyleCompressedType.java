...
import com.TheoCreates.CreateStyleCompressed.blocks.csc.*;
import com.TheoCreates.CreateStyleCompressed.blocks.minecraft.*;
...
public enum CreateStyleCompressedType {
    ...
    public static final CreateStyleCompressedType[] VALUES = values();

    public final String name;
    public final Supplier<Block> factory;
    public final List<Block> blocks;

    CreateStyleCompressedType(String n, Supplier<Block> f) {
        name = n;
        factory = f;
